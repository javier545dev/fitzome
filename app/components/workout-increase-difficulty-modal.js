...
export default ({ visible, showModal, bigLabel, smallLabel, btnLabel, }) => {
    ...
    return(
        ...
        >
            ...
            <View  style={styles.scrollView}>
                <Text style={[styles.bigLabel, { marginBottom: 20, }]}>{ bigLabel }</Text>
                
                <Text style={{...styles.smallLabel, marginBottom:20, }}>{ smallLabel }</Text>
